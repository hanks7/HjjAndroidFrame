...
public class USystem {
    ...
    public static String getVersionName() {
        return getPackageInfo(HjjApplication.getInstance()).versionName;
    }

    //版本号
    public static int getVersionCode() {
        return getPackageInfo(HjjApplication.getInstance()).versionCode;
    }
    ...
    public static String getIMSI() {
        if(!PermissionReq.judgePermisson2(HjjApplication.getInstance().getApplicationContext(), Manifest.permission.READ_PHONE_STATE))
            return "";
        TelephonyManager telephonyManager = (TelephonyManager) HjjApplication.getInstance().getApplicationContext()
